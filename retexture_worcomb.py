"""Re-bake texture on 3-worcomb with the fixed projection axes."""
import sys, shutil
...
image_paths = {
    "front": IMAGES / "front_processed.png",
    "back":  IMAGES / "back_processed.png",
    "side":  IMAGES / "side_processed.png",
}
